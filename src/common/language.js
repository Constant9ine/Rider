export default {
    ...
    static_notification_title:'PickMeCab Notification',
    ...
    ride_list_title:'My Rides(History)',
    no_car_assign_text:'No car is been assigned',
    ...
    otp:'OTP :',
    driver_assign_messege:'Driver will be Assigned Soon..',
	...
	goto_payment:'You will be redirected to the Payment Page. While at the Payment Page please input the figure of the Payable Amount and other details correctly. Thank you for using PickCab Services',
    ...
    sorry:'Sorry',
    multipleBooking:'PickMeCab currently doesn\'t support multiple bookings.',
    ...
    nb:'N.B.: Your fare will be increased if toll, route and destination changes or if ride took longer due to traffic or other forseen factors',
    confrim_booking:'Confirm Booking',
    estimate_fare_text:'This is your Estimated fare only',
    done:'Done',
    ...
    Balance:'PickMeCab Balance',
    android_channel: 'PickMeCab Notifications'
}
